    ...
    const handleNonImageFile = (file) => {
        try {
            ...
            reader.onload = async (event) => {
                ...
                if (detectedType === '2fauth_encrypted' || detectedType === 'aegis_encrypted' || detectedType === 'proton_auth_encrypted' || detectedType === 'proton_pass_pgp' || detectedType === '2fas_encrypted' || detectedType === 'ente_encrypted' || detectedType === 'bitwarden_pass_encrypted') {
