...
const EMAIL_TRANSLATIONS: Record<string, any> = {
    'zh-CN': {
        subject: '📦 2FAuth Worker 定期备份 {time}',
        intro: '您好，\n\n这是您的 2FAuth Worker 自动定期备份文件，请妥善保管。',
        filename: '文件名：{filename}',
        time: '备份时间：{time}',
        note: '注意：附件内容经过 AES-256 加密，请使用您设置的备份密码进行解密恢复。',
        footer: '---\n2FAuth Worker 自动备份系统',
        testSubject: '🔗 2FAuth Worker 备份源连接测试',
        testBody: '✅ 您的 2FAuth Worker 邮件备份源已成功连接！'
    },
    'en-US': {
        subject: '📦 2FAuth Worker Scheduled Backup {time}',
        intro: 'Hello,\n\nThis is your 2FAuth Worker automatic scheduled backup file. Please keep it safe.',
        ...
        footer: '---\n2FAuth Worker Automatic Backup System',
        testSubject: '🔗 2FAuth Worker Backup Connection Test',
        testBody: '✅ Your 2FAuth Worker email backup connection is working correctly!'
    }
};
...
export class EmailProvider implements BackupProvider {
    ...
    async testConnection(): Promise<boolean> {
        ...
        const filename = '2fa-test-email.txt';
